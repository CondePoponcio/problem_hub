...
if [ "$dificultad" = "Facil" ]
then
    scrapy crawl top_coder -a categoria=$cat -a dif2=1 -o $cat-Facil.json
    scrapy crawl codeforce -a cat=$cat -a dif1=0 -a dif2=1400 -o $cat-Facil.json
elif [ "$dificultad" = "Media" ]
then
    scrapy crawl top_coder -a categoria=$cat -a dif2=2 -o $cat-Medio.json
    scrapy crawl codeforce -a cat=$cat -a dif1=1401 -a dif2=2000 -o $cat-Medio.json
elif [ "$dificultad" = "Dificil" ]
then
    scrapy crawl top_coder -a categoria=$cat -a dif2=3 -o $cat-Dificil.json
