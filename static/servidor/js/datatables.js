 ...
 *   https://datatables.net/download/#bs4/dt-1.10.22/b-1.6.4/r-2.2.6/sb-1.0.0
 *
 * Included libraries:
 *   DataTables 1.10.22, Buttons 1.6.4, Responsive 2.2.6, SearchBuilder 1.0.0
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4/dt-1.10.22/b-1.6.4/r-2.2.6/sb-1.0.0",
